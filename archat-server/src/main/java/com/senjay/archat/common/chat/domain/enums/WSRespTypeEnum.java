...
import com.senjay.archat.common.chat.domain.vo.response.ws.*;
import com.senjay.archat.common.user.domain.vo.response.ws.WSOnlineOfflineNotify;
import com.senjay.archat.common.websocket.webRTC.WebRTCSignalMessage;
...
public enum WSRespTypeEnum {
    ...
    WEBRTC_SIGNAL_FORWARD(12,"转发信令", WebRTCSignalMessage.class),
    WEBRTC_ERROR(13,"转发时出现错误",WebRTCError.class)
    ;
